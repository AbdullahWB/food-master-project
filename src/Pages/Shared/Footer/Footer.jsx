...
const Footer = () => {
    return (
        <div className='bg-[#0e1111]'>
            <div className='w-[80%] mx-auto md:p-[130px] text-gray-100'>
                <div className='grid md:grid-cols-2 grid-cols-1 gap-7 mb-10'>
                    ...
                    <div className='grid grid-cols-3 gap-5'>
                        <div className='col-span-1'>
                            <h1 className='md:text-2xl text-xl mb-2 text-primary font-semibold'>Navigation</h1>
                            <ul>
                        ...
                        <div className='col-span-2'>
                            <h1 className='md:text-2xl text-xl mb-2 text-primary font-semibold'>About Our Food</h1>
                ...
                <hr />
                <div className='py-6 pb-20 md:pb-0 text-sm text-center text-gray-400'>
