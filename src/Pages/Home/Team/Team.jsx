...
const Team = () => {
    ...
    // console.log(teams);
    return (
        <div className='grid md:grid-cols-2 grid-cols-1 md:gap-8 mt-[130px]'>
            <div className='order-last'>
               <SingleTeam teams={teams}></SingleTeam>
            </div>
            <div className='text-left mt-10'>
                <h1 className='md:text-5xl text-3xl font-light text-gray-700'>We Have Awesome team in <span className='md:text-6xl text-4xl text-primary font-bold'>Food Master</span> Restaurant.</h1>
