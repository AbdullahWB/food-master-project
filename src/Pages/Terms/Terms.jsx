    ...
    return (
        <div className='w-[80%] mx-auto my-[130px]'>
            ...
            <ol>
                ...
                <li className='mb-5 text-gray-600'>
                If you do not agree to these terms and conditions, please do not log into our website. If you have any questions or concerns regarding these terms and conditions, please contact us.<Link className='text-primary' to='/recipes'> Back to Register page</Link>
                </li>
            </ol>
        </div>
    );
